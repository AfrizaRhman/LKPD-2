...
<body>
    ...
    function bandingkanNama($nama1, $nama2) {
        // Menghitung panjang karakter dari kedua nama menggunakan strlen(). 
        $panjangNama1 = strlen($nama1);
        $panjangNama2 = strlen($nama2);

        // Menentukan nama dengan jumlah karakter lebih banyak dengan Menampilkan nama yang lebih panjang, nama yang lebih pendek, dan selisih jumlah karakter.
    ...
    // Mengambil nilai dari $_POST['nama1'] dan $_POST['nama2'] dan memanggil fungsi bandingkanNama() untuk membandingkan nama.
